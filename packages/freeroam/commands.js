mp.events.addCommand('help', (player) => {
    player.outputChatBox(`!{#ff0000}Available Commands:`)
    player.outputChatBox(`F2 - Freeroam Menu`)
    player.outputChatBox(`F4 - Vehicle Spawner Menu`)
    player.outputChatBox(`creator - Opens Charactor Creator`)
    player.outputChatBox(`kill - Suicide`)
});
